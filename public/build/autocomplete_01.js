...
var fun = function () {
    var to = null;return function () {
        if (to) {
            clearTimeout(to);console.log('jeszcze nie', !!to);
        } else {
            console.log('nima', !!to);
...
$title.on('keyup', function (e) {
    ...
    timeout = setTimeout(function () {
        getItems(title, querryId).then(function (data) {
